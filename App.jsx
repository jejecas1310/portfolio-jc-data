    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 scroll-smooth selection:bg-emerald-100">
      ...
      {currentPage === 'admin' ? (
        <div className="pt-32 pb-24 min-h-screen max-w-6xl mx-auto px-6 text-left">
          ...
          <h1 className="text-4xl font-black mb-8 italic uppercase text-slate-900 tracking-tight">Espace Admin</h1>
          {!isAdminAuthenticated ? (
            <div className="max-w-md mx-auto bg-white p-12 rounded-[2.5rem] shadow-xl text-center">
              ...
              <h2 className="text-2xl font-bold mb-6 italic uppercase text-slate-900">Accès Sécurisé</h2>
            ...
            <div className="space-y-8">
              <h2 className="text-2xl font-bold uppercase italic text-slate-900">Demandes Prospects ({leads.length})</h2>
        ...
        currentPage === 'home' ? (
          <>
            ...
            <section id="services" className="py-24 bg-slate-50 scroll-mt-20">
              <div className="max-w-7xl mx-auto px-6 text-left text-slate-900">
                <div className="max-w-2xl mb-16 border-l-4 border-emerald-600 pl-8">
                  ...
                  <p className="text-3xl lg:text-4xl font-bold italic text-left">Solutions d'ingénierie Excel sur-mesure.</p>
                </div>
            ...
            {/* PRESTATIONS EXPRESS (RESTO EN JAUNE/AMBER) */}
            <section id="express" className="py-24 bg-slate-900 overflow-hidden relative scroll-mt-20 text-white">
              <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="mb-16 text-center lg:text-left">
                  ...
                  <h2 className="text-base font-bold text-amber-400 uppercase tracking-widest mb-3 italic text-center lg:text-left">Forfaits d'Intervention</h2>
                  <p className="text-3xl lg:text-5xl font-black mb-6 uppercase tracking-tighter italic text-center lg:text-left">Solutions Prêtes à l'Emploi</p>
            ...
            <section id="expertise" className="py-24 bg-white scroll-mt-20">
              <div className="max-w-7xl mx-auto px-6 text-center">
                <div className="mb-16 text-center">
                  ...
                  <p className="text-3xl lg:text-4xl font-bold italic text-slate-900 italic">Démonstration d'Expertise</p>
                  <p className="text-slate-500 mt-4 italic max-w-2xl mx-auto">Voici comment je transforme vos problématiques en solutions techniques performantes.</p>
                </div>
                <div className="grid md:grid-cols-3 gap-8 text-left">
                  {expertiseCases.map((p, i) => (
                    <div key={i} className="bg-slate-50 rounded-[2.5rem] shadow-sm border border-slate-100 p-10 hover:shadow-xl transition-all group">
                      <div className="flex items-center gap-2 text-emerald-600 font-black text-xs uppercase mb-4 tracking-tighter italic"><CheckCircle2 size={16} /> {p.impact}</div>
                      ...
                      <p className="text-slate-600 leading-relaxed italic text-sm">"{p.description}"</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <section id="methodology" className="py-24 bg-emerald-600 scroll-mt-20 text-white relative italic">
               ...
               <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                 <div className="mb-16">
                    <h2 className="text-base font-bold text-emerald-100 uppercase tracking-widest mb-3 italic">Valeurs</h2>
                    <p className="text-3xl lg:text-5xl font-black italic tracking-tight uppercase">Engagement & Qualité</p>
                 </div>
                 <div className="grid md:grid-cols-3 gap-8">
                    {methodology.map((m, i) => (
                      <div key={i} className="bg-white rounded-[2.5rem] p-10 shadow-2xl transform hover:-translate-y-2 transition-all text-slate-900 text-center">
                        ...
                        <p className="text-slate-600 italic text-sm leading-relaxed">"{m.content}"</p>
                      </div>
                    ))}
                 </div>
               </div>
            ...
            <div className="p-8 overflow-y-auto text-left">
              {!aiResult ? (
                ...
                <div className="space-y-6">
                  <div className="bg-emerald-50 p-8 rounded-[2rem] border border-emerald-100 whitespace-pre-wrap leading-relaxed text-left text-slate-800 shadow-sm text-sm italic">
                    <div className="text-emerald-700 font-bold mb-4 flex items-center gap-2 border-b border-emerald-100 pb-2 uppercase text-xs tracking-widest not-italic italic underline decoration-emerald-200 italic font-black"><Sparkles size={14}/> Stratégie Suggérée</div>
                    {aiResult}
                  </div>
                  <div className="p-6 bg-slate-900 rounded-[2rem] text-white flex flex-col sm:flex-row items-center gap-6 shadow-xl text-left">
                    <div className="flex-1">
                        <div className="text-emerald-400 font-black uppercase text-xs tracking-widest mb-1 italic">Valider cette analyse ?</div>
                        <p className="text-xs text-slate-400 italic leading-relaxed">Échangeons 15 minutes pour confirmer le budget et la faisabilité.</p>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 mb-20 text-left italic">
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-12 text-white italic">
            ...
            <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden text-slate-900 text-left italic">
              {isSubmitted ? (
                ...
                <form className="space-y-4" onSubmit={handleContactSubmit}>
                  <h3 className="text-2xl font-bold mb-8 font-black tracking-tight text-left uppercase italic text-slate-900 italic underline decoration-emerald-500/20">Demander un audit gratuit</h3>
...
const DetailsTemplate = ({ title, subtitle, description, icon: Icon, examples, colorClass, goBack }) => (
  <div className="pt-32 pb-24 animate-in fade-in duration-700 bg-white min-h-screen text-slate-900 text-left italic">
    <div className="max-w-4xl mx-auto px-6">
      <button onClick={goBack} className="flex items-center gap-2 text-slate-500 hover:text-emerald-600 font-bold text-sm mb-12 group transition-all italic">
      ...
      <div className="mb-16">
        ...
        <p className="text-xl text-slate-600 leading-relaxed text-left italic leading-relaxed">{description}</p>
      </div>
      <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 text-white mb-12 shadow-2xl border border-white/5 text-left italic">
        <h2 className="text-3xl font-bold mb-12 text-center underline decoration-emerald-500 underline-offset-8 uppercase tracking-widest leading-loose text-white italic">Cas d'Expertise</h2>
          ...
          {examples.map((ex, i) => (
            <div key={i} className="flex flex-col md:flex-row gap-8 items-start text-left">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-400 leading-relaxed mb-4 text-left italic">"{ex.context}"</p>
